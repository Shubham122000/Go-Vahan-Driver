...
import com.govahanpartner.com.databinding.RowDriverListBinding
import com.govahanpartner.com.ui.vendor.TripDetailOfAssignedDriverActivity


class DriverAssignedListAdapter (val context : Context, val list: List<String>) : RecyclerView.Adapter<DriverAssignedListAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
       ...
       holder.binding.btnView.setOnClickListener(View.OnClickListener {
        ...
        holder.binding.linearItem.setOnClickListener(View.OnClickListener {
           val intent = Intent(context, TripDetailOfAssignedDriverActivity::class.java)
