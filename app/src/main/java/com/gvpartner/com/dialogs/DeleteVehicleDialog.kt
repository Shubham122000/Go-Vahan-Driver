package com.gvpartner.com.dialogs
...
class DeleteVehicleDialog(var deleteVehicle: deleteVehicle,var id:Int?) : DialogFragment() {


        override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
            var view= inflater.inflate(R.layout.delete_vehicle_popup, container, false)
