...
class InvoiceResponse {
    ...
    @SerializedName("data"         ) var data         : ArrayList<InvoiceResponseData> = ArrayList()
    @SerializedName("ownerDetails" ) var ownerDetails : ArrayList<InvoiceResponseOwnerDetails> = ArrayList()
    @SerializedName("userDetails"  ) var userDetails  : InvoiceResponseUserDetails?    = InvoiceResponseUserDetails()
}
...
data class InvoiceResponseOwnerDetails (
    @SerializedName("name"   ) var name   : String? = null,
    @SerializedName("email"  ) var email  : String? = null,
    @SerializedName("mobile" ) var mobile : String? = null
)

data class InvoiceResponseUserDetails (
